...
if ($password == $password2) {
  $users = $mysqli->query("INSERT INTO users (surname, name, patronymic, phone, login, password, avatar, role) VALUES ('$surname','$name', '$midname', '$phone', '$login', '$password', 'img/аватарки/base.svg', 'клиент')");
